...
public class NaverLogicSub {
    ...
    public Member accessTokenToProfile(NaverOauthToken naverOauthToken) {
        ...
        log.info("[START] - NaverLogicSub.accessTokenToProfile / 네이버에서 발급받은 토큰 [naverOauthToken : " + naverOauthToken + "] 를 이용하여 프로필 정보 요청하기 시작  ---------------------------------------------------------------------------------");
        ...
        log.info("[END] - NaverLogicSub.accessTokenToProfile / 네이에서 발급받은 토큰 [naverOauthToken : " + naverOauthToken + "] 를 이용하여 프로필 정보 요청하기 완료  ---------------------------------------------------------------------------------");
