...
public class GoogleLogicSub {
    ...
    public Member joinCheck(Member googleUser) {
        ...
        log.info("[START] - GoogleLogicSub.joinCheck / [email : " + googleUser.getEmail() + "]  email 중복여부 체크 및 회원가입 로직 시작 ----------------------------------------------------------------------------------------------------------------------------------------------------------");
        ...
        if (duplicateEmailMember == null) {
            ...
            log.info("[END] - GoogleLogicSub.joinCheck / [email : " + googleUser.getEmail() + "]  email 중복여부 체크 및 회원가입 로직 종료 ----------------------------------------------------------------------------------------------------------------------------------------------------------");
    ...
    public ResponseEntity<String> googleAutoLogin(Member googleUser) {
        log.info("[START] - GoogleLogicSub.googleAutoLogin / [email : " + googleUser.getEmail() + "]  해당 회원은 Google 로 회원가입 되어있으므로 자동 로그인 로직 시작 ----------------------------------------------------------------------------------------------------------------------------------------------------------");
        ...
        if (responseEntity.getStatusCode().is2xxSuccessful()) {
            ...
            log.info("[END] - GoogleLogicSub.googleAutoLogin / [email : " + googleUser.getEmail() + "]  해당 회원은 Google 로 회원가입 되어있으므로 자동 로그인 로직 종료 ----------------------------------------------------------------------------------------------------------------------------------------------------------");
    ...
    public ResponseEntity<String> googleAutoLoginFail(String email, String provider) {
        log.info("[START] - GoogleLogicSub.googleAutoLoginFail / [email : " + email + "] 해당 회원은 " + provider + " 로 회원가입 되어있으므로 자동 로그인 실패 응답 시작 ----------------------------------------------------------------------------------------------------------------------------------------------------------");
        ...
        log.info("[END] - GoogleLogicSub.googleAutoLoginFail / [email : " + email + "] 해당 회원은 " + provider + " 로 회원가입 되어있으므로 자동 로그인 실패 응답 완료 ----------------------------------------------------------------------------------------------------------------------------------------------------------");
