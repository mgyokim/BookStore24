...
public class KakaoLogicSub {
    ...
    public Member accessTokenToProfile(KakaoOauthToken kakaoOauthToken) {
        ...
        log.info("[START] - KakaoLogicSub.accessTokenToProfile / 카카오에서 발급받은 토큰 [kakaoOauthToken : " + kakaoOauthToken + "] 를 이용하여 프로필 정보 요청하기 시작  ---------------------------------------------------------------------------------");
        ...
        log.info("[END] - KakaoLogicSub.accessTokenToProfile / 카카오에서 발급받은 토큰 [kakaoOauthToken : " + kakaoOauthToken + "] 를 이용하여 프로필 정보 요청하기 완료  ---------------------------------------------------------------------------------");
