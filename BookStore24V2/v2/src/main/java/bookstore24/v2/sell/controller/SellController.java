...
public class SellController {
    ...
    @GetMapping("/sell/post/list/search/by/nickname")
    public Page<SellPostListSearchByNicknameResponseDto> sellPostListSearchByNickname(@RequestParam(value = "keyword") String title, @RequestParam(value = "page", defaultValue = "0") int page, @RequestParam(value = "size", defaultValue = "10") int size) {
        ...
        return sellService.searchSellsByMemberNicknameKeywords(title, pageable)
                .map(sell -> {
                    ...
                    sellPostListSearchByNicknameResponseDto.setTitle(sell.getTitle());
                    sellPostListSearchByNicknameResponseDto.setStatus(sell.getStatus());
                    sellPostListSearchByNicknameResponseDto.setCoverImg(sell.getBook().getCoverImg());
                    sellPostListSearchByNicknameResponseDto.setBookTitle(sell.getBook().getTitle());
                    sellPostListSearchByNicknameResponseDto.setAuthor(sell.getBook().getAuthor());
                    sellPostListSearchByNicknameResponseDto.setPublisher(sell.getBook().getPublisher());
                    sellPostListSearchByNicknameResponseDto.setPrice(sell.getPrice());
                    sellPostListSearchByNicknameResponseDto.setNickname(sell.getMember().getNickname());
                    sellPostListSearchByNicknameResponseDto.setLoginId(sell.getMember().getLoginId());
                    sellPostListSearchByNicknameResponseDto.setCreatedDate(sell.getCreatedDate());
                    sellPostListSearchByNicknameResponseDto.setView(sell.getView());
